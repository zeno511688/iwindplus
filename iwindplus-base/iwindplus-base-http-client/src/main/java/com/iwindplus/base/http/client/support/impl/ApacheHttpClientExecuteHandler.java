 ...
 */
@Slf4j
public class ApacheHttpClientExecuteHandler extends AbstractHttpClientExecuteHandler implements HttpClientExecuteHandler {

    private final CloseableHttpClient closeableHttpClient;
    private final CloseableHttpAsyncClient closeableHttpAsyncClient;

    public ApacheHttpClientExecuteHandler(
        HttpClientProperty property,
        HttpExecuteTemplate executeTemplate,
        ResponseExtractorFactory extractorFactory,
        ThreadPoolExecutor threadPoolExecutor,
        CloseableHttpClient closeableHttpClient,
        CloseableHttpAsyncClient closeableHttpAsyncClient) {

        super(property, executeTemplate, extractorFactory, threadPoolExecutor);
