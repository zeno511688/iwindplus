...
package com.iwindplus.base.logging.alert.support;
 ...
 */
public class LoggingAlertAppender extends AppenderBase<ILoggingEvent> {
    ...
    public LoggingAlertAppender(LoggingAlertProperty property,
        AlertExecuteHandlerFactory alertExecuteHandlerFactory,
        Environment environment) {
        this.property = property;
        this.alertExecuteHandlerFactory = alertExecuteHandlerFactory;
    ...
    private void sendAlert(ILoggingEvent event) {
        ChannelCfg channel = property.getChannel();
        if (channel == null) {
            return;
        }
