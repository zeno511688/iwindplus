 ...
 */
@Slf4j
public class SumSubWebhookHandlerFactory implements SmartInitializingSingleton {
     ...
     */
    public SumSubWebhookHandlerFactory(SumSubWebhookListenerProcessor listenerProcessor) {
        this.strategyMapSupplier = SingletonSupplier.of(() -> {
            ...
            log.info("Loaded {} strategies (annotation: {})",
                SumSubWebhookHandlerFactory.class.getSimpleName(),
                strategyMap.size()
            );
