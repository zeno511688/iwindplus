...
package com.iwindplus.base.sumsub.domain.constant;
...
public final class SumSubConstant {
    ...
    public static final class Url {
        ...
        /**
         * 根据外部用户ID查询申请人接口（需要拼接externalUserId）.
         */
        public static final String APPLICANT_BY_EXTERNAL_USER_ID = APPLICANT + "/-;externalUserId=%s/one";
