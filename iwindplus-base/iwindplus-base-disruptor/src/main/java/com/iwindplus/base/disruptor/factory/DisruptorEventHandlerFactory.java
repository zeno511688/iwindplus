 ...
 */
@Slf4j
public class DisruptorEventHandlerFactory implements SmartInitializingSingleton {
     ...
     */
    public DisruptorEventHandlerFactory(ObjectProvider<DisruptorEventHandler<?>> executorProvider) {
