 ...
 *
 * @author zengdegui
 * @since 2026/07/19 17:21
 */
public class CustomKafkaListenerObservationConvention extends DefaultKafkaListenerObservationConvention {
    ...
    private String getHeader(
        ...
        ConsumerRecord<?, ?> record = context.getRecord();
        if (record == null) {
            return null;
        }
