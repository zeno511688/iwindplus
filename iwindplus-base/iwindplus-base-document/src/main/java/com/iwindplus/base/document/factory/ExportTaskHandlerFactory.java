 ...
 */
@Slf4j
public class ExportTaskHandlerFactory implements SmartInitializingSingleton {
     ...
     */
    public ExportTaskHandlerFactory(ObjectProvider<ExportTaskHandler> handlerProvider) {
