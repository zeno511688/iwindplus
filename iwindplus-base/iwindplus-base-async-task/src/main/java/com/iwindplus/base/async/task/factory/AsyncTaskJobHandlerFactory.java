 ...
 */
@Slf4j
public class AsyncTaskJobHandlerFactory implements SmartInitializingSingleton {
     ...
     */
    public AsyncTaskJobHandlerFactory(ObjectProvider<AsyncTaskJobHandler> executorProvider) {
