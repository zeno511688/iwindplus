 ...
 */
@Schema(description = "异步任务组任务提交数据传输对象")
@Data
@SuperBuilder
@EqualsAndHashCode(callSuper = true)
@NoArgsConstructor
@AllArgsConstructor
public class AsyncTaskGroupSubmitDTO extends AsyncTaskSubmitBaseDTO {

    /**
     * 执行器类（必填）.
     */
    @Schema(description = "执行器类")
    private Class<? extends AsyncTaskHandler> executorClass;
    ...
    private List<AsyncTaskSubSubmitDTO> subTasks;
}
