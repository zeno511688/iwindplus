 ...
 * @since 2025/9/14
 */
@Schema(description = "异步任务子任务视图对象")
@Data
@EqualsAndHashCode(callSuper = true)
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public class AsyncTaskSubVO extends AsyncTaskSubBaseVO {
    ...
    private transient List<AsyncTaskSubVO> priorSubTasks;
