 ...
 */
@Slf4j
public class GroupAsyncTaskExecuteHandler extends AbstractAsyncTaskExecuteHandler {
    ...
    public GroupAsyncTaskExecuteHandler(
        ...
        super(asyncTaskHandlerFactory, asyncTaskStateSupport, asyncTaskService);
        this.asyncTaskSubService = asyncTaskSubService;
        this.asyncTaskSubHandlerFactory = asyncTaskSubHandlerFactory;
    ...
    private AsyncTaskSubHandler getSubTaskHandler(String executeName) {
        return this.asyncTaskSubHandlerFactory.getTaskHandler(executeName);
    }
