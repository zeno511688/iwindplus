 ...
 */
@Slf4j
public class AsyncTaskHandlerFactory implements SmartInitializingSingleton {
     ...
     */
    public AsyncTaskHandlerFactory(ObjectProvider<AsyncTaskHandler> executorProvider) {
