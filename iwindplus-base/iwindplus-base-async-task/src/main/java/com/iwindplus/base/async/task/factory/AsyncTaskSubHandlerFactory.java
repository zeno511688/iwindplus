 ...
 */
@Slf4j
public class AsyncTaskSubHandlerFactory implements SmartInitializingSingleton {
     ...
     */
    public AsyncTaskSubHandlerFactory(ObjectProvider<AsyncTaskSubHandler> executorProvider) {
