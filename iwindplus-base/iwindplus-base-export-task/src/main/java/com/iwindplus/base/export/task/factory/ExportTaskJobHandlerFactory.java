 ...
 */
@Slf4j
public class ExportTaskJobHandlerFactory implements SmartInitializingSingleton {
     ...
     */
    public ExportTaskJobHandlerFactory(ObjectProvider<ExportTaskJobHandler> handlerProvider) {
