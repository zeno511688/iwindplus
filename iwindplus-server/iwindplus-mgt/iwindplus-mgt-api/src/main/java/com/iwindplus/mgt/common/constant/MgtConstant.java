...
package com.iwindplus.mgt.common.constant;
...
public class MgtConstant {
    ...
    public static class RedisCacheConstant {
         ...
         * 用户扩展绑定授权缓存名称.
         */
        public static final String CACHE_USER_EXTEND_BIND_GRANT = "userExtendBindGrant";
    ...
    public static final class WechatConstant {
         ...
         * 绑定编码.
         */
        public static final String BIND_CODE = "code";
