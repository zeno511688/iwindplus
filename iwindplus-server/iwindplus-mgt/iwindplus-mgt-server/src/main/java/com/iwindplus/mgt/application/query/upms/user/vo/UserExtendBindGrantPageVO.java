...
package com.iwindplus.mgt.application.query.upms.user.vo;
 ...
 * @since 2019/7/16
 */
@Schema(description = "用户扩展绑定授权分页视图对象")
@Data
@EqualsAndHashCode(callSuper = true)
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public class UserExtendBindGrantPageVO extends DbVersionBaseVO {
