...
import com.iwindplus.mgt.application.service.test.VideoDemoAsyncTaskApplicationService;
...
public class VideoDemoAsyncTaskController extends BaseController {
    ...
    private final VideoDemoAsyncTaskApplicationService videoDemoAsyncTaskApplicationService;
    ...
    public ResultVO<AsyncTaskSubmitVO> submitMergeGroup(@RequestParam String videoId) {
        AsyncTaskSubmitVO data = this.videoDemoAsyncTaskApplicationService.submitMergeGroup(videoId);
    ...
    public ResultVO<AsyncTaskSubmitVO> submitSingle(@RequestParam String videoId) {
        AsyncTaskSubmitVO data = this.videoDemoAsyncTaskApplicationService.submitSingle(videoId);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> callbackSuccess(
        ...
        this.videoDemoAsyncTaskApplicationService.mockThirdCallbackSuccess(submitBizNumber, fileUrl);
    ...
    public ResultVO<Boolean> callbackFailed(
        ...
        this.videoDemoAsyncTaskApplicationService.mockThirdCallbackFailed(submitBizNumber, errorMsg);
        return ResultVO.success(Boolean.TRUE);
    }
    ...
    public ResultVO<Boolean> retry(@RequestParam String bizNumber) {
        this.videoDemoAsyncTaskApplicationService.retryByBizNumber(bizNumber);
        return ResultVO.success(Boolean.TRUE);
    }
}
