...
package com.iwindplus.mgt.application.service.upms.organization.dto;
 ...
 * @since 2019/6/12
 */
@Schema(description = "职位数据传输对象")
@Data
@EqualsAndHashCode(callSuper = true)
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public class PositionDTO extends DbVersionBaseDTO {
     ...
     * 部门主键.
     */
    @NotNull(message = "{departmentId.notEmpty}", groups = {SaveGroup.class, EditGroup.class})
