...
import com.iwindplus.mgt.application.query.upms.user.UserExtendYubikeyQueryService;
...
import com.iwindplus.mgt.application.service.upms.user.UserExtendYubikeyApplicationService;
...
public class UserExtendYubikeyController extends BaseController {
    ...
    private final UserExtendYubikeyApplicationService userExtendYubikeyApplicationService;
    private final UserExtendYubikeyQueryService userExtendYubikeyQueryService;
    ...
    public ResultVO<Boolean> save(@RequestBody @Validated({SaveGroup.class}) UserExtendYubikeySaveDTO entity) {
        boolean data = this.userExtendYubikeyApplicationService.save(entity);
    ...
    public ResultVO<Boolean> removeByIds(@RequestParam List<Long> ids) {
        boolean data = this.userExtendYubikeyApplicationService.removeByIds(ids);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> edit(@RequestBody @Validated({EditGroup.class}) UserExtendYubikeyEditDTO entity) {
        boolean data = this.userExtendYubikeyApplicationService.edit(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<UserExtendYubikeyVO> getByUserId(
        ...
        UserExtendYubikeyVO data = this.userExtendYubikeyQueryService.getByUserId(userId, bizType);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<IPage<UserExtendYubikeyPageVO>> pageByUserId(@Validated UserExtendYubikeySearchDTO entity) {
        IPage<UserExtendYubikeyPageVO> data = this.userExtendYubikeyQueryService.pageByUserId(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<UserExtendYubikeyVO> getDetail(@RequestParam Long id) {
        UserExtendYubikeyVO data = this.userExtendYubikeyQueryService.getDetail(id);
        return ResultVO.success(data);
    }
}
