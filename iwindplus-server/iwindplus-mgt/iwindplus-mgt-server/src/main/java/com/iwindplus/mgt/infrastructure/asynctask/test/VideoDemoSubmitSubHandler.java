...
package com.iwindplus.mgt.infrastructure.asynctask.test;
 ...
 * 等待业务通过AsyncTaskExecutor.callback预存回调结果（优先），
...
public class VideoDemoSubmitSubHandler implements AsyncTaskSubHandler {
    ...
    public AsyncTaskExecuteResultVO executeSub(AsyncTaskSubVO entity) {
        ...
        // 第三方处理完成后回调业务接口，业务再调用AsyncTaskExecutor.callback上报
