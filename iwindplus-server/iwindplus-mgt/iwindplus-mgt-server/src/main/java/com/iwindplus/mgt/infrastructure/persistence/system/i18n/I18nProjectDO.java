...
package com.iwindplus.mgt.infrastructure.persistence.system.i18n;
 ...
 * @since 2020/4/14
 */
@Schema(description = "国际化项目对象")
@TableName(value = "`i18n_project`")
@Data
@SuperBuilder
@EqualsAndHashCode(callSuper = true)
@NoArgsConstructor
@AllArgsConstructor
public class I18nProjectDO extends DbBaseDO {
