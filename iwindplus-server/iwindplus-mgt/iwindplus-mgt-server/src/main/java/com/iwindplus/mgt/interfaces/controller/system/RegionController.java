...
import com.iwindplus.mgt.application.query.system.region.RegionQueryService;
import com.iwindplus.mgt.application.query.system.region.vo.RegionVO;
import com.iwindplus.mgt.application.service.system.region.RegionApplicationService;
...
@Slf4j
@RestController
@RequestMapping("admin/mgt/region")
@Validated
@RequiredArgsConstructor
public class RegionController extends BaseController {

    private final RegionApplicationService regionApplicationService;
    ...
    public ResultVO<Boolean> save(@RequestBody @Validated({SaveGroup.class}) RegionSaveDTO entity) {
        boolean data = this.regionApplicationService.save(entity);
    ...
    public ResultVO<Boolean> removeByIds(@RequestParam List<Long> ids) {
        boolean data = this.regionApplicationService.removeByIds(ids);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> edit(@RequestBody @Validated({EditGroup.class}) RegionEditDTO entity) {
        boolean data = this.regionApplicationService.edit(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> editStatus(@RequestParam Long id, @RequestParam EnableStatusEnum status) {
        boolean data = this.regionApplicationService.editStatus(id, status);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> editBuildIn(@RequestParam Long id, @RequestParam Boolean buildInFlag) {
        boolean data = this.regionApplicationService.editBuildIn(id, buildInFlag);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<List<Tree<Long>>> listEnabled() {
        List<Tree<Long>> data = this.regionQueryService.listByEnabled(EnableStatusEnum.ENABLE);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<List<Tree<Long>>> listAll() {
        List<Tree<Long>> data = this.regionQueryService.listByEnabled(null);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<RegionVO> getDetail(@RequestParam Long id) {
        RegionVO data = this.regionQueryService.getDetail(id);
        return ResultVO.success(data);
    }
}
