...
package com.iwindplus.mgt.application.query.upms.user.dto;
 ...
 */
@Schema(description = "用户扩展绑定授权搜索数据传输对象")
@Data
@EqualsAndHashCode(callSuper = true)
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public class UserExtendBindGrantSearchDTO extends DbPageDTO {
