...
import com.iwindplus.mgt.application.query.system.i18n.I18nMsgQueryService;
...
import com.iwindplus.mgt.application.service.system.i18n.I18nMsgApplicationService;
...
public class I18nMsgController extends BaseController {
    ...
    private final I18nMsgApplicationService i18nMsgApplicationService;
    private final I18nMsgQueryService i18nMsgQueryService;
    ...
    public ResultVO<Boolean> save(@RequestBody @Validated({SaveGroup.class}) I18nMsgDTO entity) {
        boolean data = this.i18nMsgApplicationService.save(entity);
    ...
    public ResultVO<Boolean> removeByIds(@RequestParam List<Long> ids) {
        boolean data = this.i18nMsgApplicationService.removeByIds(ids);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> edit(@RequestBody @Validated({EditGroup.class}) I18nMsgDTO entity) {
        boolean data = this.i18nMsgApplicationService.edit(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> editStatus(@RequestParam Long id, @RequestParam EnableStatusEnum status) {
        boolean data = this.i18nMsgApplicationService.editStatus(id, status);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> editBuildIn(@RequestParam Long id, @RequestParam Boolean buildInFlag) {
        boolean data = this.i18nMsgApplicationService.editBuildIn(id, buildInFlag);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<IPage<I18nMsgPageVO>> page(@Validated I18nMsgSearchDTO entity) {
        IPage<I18nMsgPageVO> data = this.i18nMsgQueryService.page(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<I18nMsgExtendVO> getDetail(@RequestParam Long id) {
        I18nMsgExtendVO data = this.i18nMsgQueryService.getDetail(id);
        return ResultVO.success(data);
    }
}
