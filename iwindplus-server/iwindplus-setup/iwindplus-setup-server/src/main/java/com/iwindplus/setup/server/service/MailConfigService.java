...
public interface MailConfigService {
     ...
     * @return boolean
     */
    boolean save(MailConfigSaveDTO entity);
     ...
     * @return boolean
     */
    boolean saveOrEditBatch(List<MailConfigDTO> entities);
     ...
     * @return boolean
     */
    boolean edit(MailConfigEditDTO entity);
     ...
     * @param page   分页对象
     * @param entity 对象
     * @return IPage<MailConfigPageVO>
     */
    IPage<MailConfigPageVO> page(PageDTO<MailConfigDO> page, MailConfigSearchDTO entity);
     ...
     * @return MailConfigVO
     */
    MailConfigVO getByCode(String code);

    /**
     * 启用的列表.
     *
     * @return MailConfigBaseVO
     */
    List<MailConfigBaseVO> listEnabled();
     ...
     * @return MailConfigVO
     */
    MailConfigVO getDetail(Long id);
