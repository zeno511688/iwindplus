...
import com.iwindplus.setup.server.dal.mapper.OssConfigMapper;
 ...
 */
@Repository
public class OssConfigRepository extends JoinCrudRepository<OssConfigMapper, OssConfigDO> {
    ...
    public void getNameIsExist(String name, Long orgId) {
        final LambdaQueryWrapper<OssConfigDO> queryWrapper = Wrappers.lambdaQuery(OssConfigDO.class)
            .eq(OssConfigDO::getOrgId, orgId)
            .eq(OssConfigDO::getName, name);
