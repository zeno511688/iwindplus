...
public class SmsConfigServiceImpl implements SmsConfigService {
    ...
    public void importByTemplate(MultipartFile file, UserBaseVO userInfo, HttpServletResponse response) {
        ...
        try {
            importResult = ExcelsUtil.importExcel(file.getInputStream(), this.validator, null, SmsConfigImportDTO.class,
        ...
        if (CollUtil.isNotEmpty(failList)) {
            ...
            ExcelsUtil.exportExcel(response, failList, SmsConfigImportDTO.class, fileName, null);
        } else {
            // 正确的数据处理
