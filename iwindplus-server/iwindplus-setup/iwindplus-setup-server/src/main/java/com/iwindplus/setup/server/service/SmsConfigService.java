...
public interface SmsConfigService {
     ...
     * @return boolean
     */
    boolean save(SmsConfigSaveDTO entity);
     ...
     * @return boolean
     */
    boolean saveOrEditBatch(List<SmsConfigDTO> entities);
     ...
     * @return boolean
     */
    boolean edit(SmsConfigEditDTO entity);
     ...
     * @param page   分页对象
     * @param entity 对象
     * @return IPage<SmsConfigPageVO>
     */
    IPage<SmsConfigPageVO> page(PageDTO<SmsConfigDO> page, SmsConfigSearchDTO entity);
     ...
     * @return SmsConfigVO
     */
    SmsConfigVO getByCode(String code);

    /**
     * 启用的列表.
     *
     * @return SmsConfigBaseVO
     */
    List<SmsConfigBaseVO> listEnabled();
