 ...
 * @since 2018/9/1
 */
@Schema(description = "视频点播配置数据传输对象")
@Data
@EqualsAndHashCode(callSuper = true)
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public class VodConfigDTO extends DbVersionBaseDTO {
    ...
    @NotNull(message = "{vodType.notEmpty}", groups = {SaveGroup.class, EditGroup.class})
    ...
    @NotBlank(message = "{region.notEmpty}", groups = {SaveGroup.class, EditGroup.class})
    @Length(max = 100, message = "{region.length}", groups = {SaveGroup.class, EditGroup.class})
