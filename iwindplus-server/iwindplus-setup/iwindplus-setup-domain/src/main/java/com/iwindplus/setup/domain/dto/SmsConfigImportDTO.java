 ...
 * @since 2018/9/1
 */
@Schema(description = "短信配置导入数据传输对象")
@Data
...
public class SmsConfigImportDTO extends ExcelImportResultBaseVO {
     ...
     * 类型.
     */
    @NotNull(message = "{smsType.notEmpty}")
    @ColumnWidth(value = 20)
    ...
    @ExcelProperty(value = {"*访问key"}, index = 2)
    @ColumnWidth(value = 20)
    ...
    @ExcelProperty(value = {"*密匙"}, index = 3)
    @ColumnWidth(value = 20)
     ...
     * sts地域节点（可选）.
     */
    @ExcelProperty(value = {"sts地域节点"}, index = 4)
     ...
     * RAM角色（可选）.
     */
    @ExcelProperty(value = {"RAM角色"}, index = 5)
    @ColumnWidth(value = 20)
