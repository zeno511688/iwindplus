 ...
 * @since 2018/9/1
 */
@Schema(description = "短信配置数据传输对象")
@Data
@EqualsAndHashCode(callSuper = true)
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public class SmsConfigDTO extends DbVersionBaseDTO {
    /**
    ...
    @NotNull(message = "{smsType.notEmpty}", groups = {SaveGroup.class, EditGroup.class})
