 ...
 * @since 2020/4/27
 */
@Schema(description = "邮件模板数据传输对象")
@Data
@EqualsAndHashCode(callSuper = true)
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public class MailTplDTO extends DbVersionBaseDTO {
    ...
    @Length(max = 5000, message = "{template.length}", groups = {SaveGroup.class, EditGroup.class})
