...
package com.iwindplus.binlog.interfaces.listener;
...
import com.iwindplus.binlog.application.binlog.BinlogActionApplicationService;
...
public class BinLogConsumerListener {
    ...
    @Resource
    private BinlogActionApplicationService binlogActionApplicationService;
    ...
    private void processData(List<BinlogRowDataDTO> entities) {
        try {
            this.binlogActionApplicationService.processHandler(entities);
        } catch (Exception ex) {
