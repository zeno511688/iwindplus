...
package com.iwindplus.binlog.comsumer.server;
...
@EnableAsync
@EnableDynamicTp
public class BinlogConsumerApplication {

    public static void main(String[] args) throws UnknownHostException {
        System.setProperty("nacos.logging.default.config.enabled", "false");
        ConfigurableApplicationContext application = SpringApplication.run(BinlogConsumerApplication.class, args);
