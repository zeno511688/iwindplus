...
package com.iwindplus.binlog.producer.server;
...
@EnableAsync
@EnableDynamicTp
public class BinlogProducerApplication {

    public static void main(String[] args) throws UnknownHostException {
        System.setProperty("nacos.logging.default.config.enabled", "false");
        ConfigurableApplicationContext application = SpringApplication.run(BinlogProducerApplication.class, args);
