...
package com.iwindplus.log.interfaces.jobhandler;
...
public class CaptchaLogExpireJob {
    ...
    @Resource
    private SmsCaptchaLogApplicationService smsCaptchaLogService;

    @Resource
    private MailCaptchaLogApplicationService mailCaptchaLogService;
