...
import com.iwindplus.log.application.query.BinlogAlertQueryService;
...
import com.iwindplus.log.application.service.BinlogAlertApplicationService;
...
public class BinlogAlertController extends BaseController {
    ...
    private final BinlogAlertApplicationService binlogAlertApplicationService;
    private final BinlogAlertQueryService binlogAlertQueryService;
    ...
    public ResultVO<Boolean> save(@RequestBody @Validated({SaveGroup.class}) BinlogAlertDTO entity) {
        boolean data = this.binlogAlertApplicationService.save(entity);
    ...
    public ResultVO<Boolean> removeByIds(@RequestParam List<String> ids) {
        boolean data = this.binlogAlertApplicationService.removeByIds(ids);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<IPage<BinlogAlertPageVO>> page(@Validated BinlogAlertSearchDTO entity) {
        IPage<BinlogAlertPageVO> data = this.binlogAlertQueryService.page(entity);
        return ResultVO.success(data);
    }
     ...
     *
     * @param entity 对象
     * @return ResultVO<EsPageDTO < BinlogAlertPageVO>>
     */
    @Operation(summary = "列表(深分页)")
    @GetMapping("pageByAfter")
    public ResultVO<EsPageDTO<BinlogAlertPageVO>> pageByAfter(@Validated BinlogAlertSearchAfterDTO entity) {
        EsPageDTO<BinlogAlertPageVO> data = this.binlogAlertQueryService.pageByAfter(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<BinlogAlertVO> getDetail(@RequestParam String id) {
        BinlogAlertVO data = this.binlogAlertQueryService.getDetail(id);
        return ResultVO.success(data);
    }
