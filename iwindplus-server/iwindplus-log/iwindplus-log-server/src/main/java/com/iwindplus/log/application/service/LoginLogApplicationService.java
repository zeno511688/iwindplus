...
public class LoginLogApplicationService {
    ...
    public boolean save(LoginLogDTO entity) {
        ...
        this.loginLogRepository.save(model);
    ...
    public boolean saveBatch(List<LoginLogDTO> entities) {
        ...
        if (CollUtil.isNotEmpty(entities)) {
            ...
            this.loginLogRepository.saveBatch(BeanUtil.copyToList(entities, LoginLogDO.class));
        }
        return false;
    }
    ...
    public boolean removeByIds(List<String> ids) {
        List<LoginLogDO> data = this.loginLogRepository.listById(ids);
        if (CollUtil.isEmpty(data)) {
            throw new BizException(BizCodeEnum.DATA_NOT_EXIST);
        }
        this.loginLogRepository.removeByIds(ids, false);
        return Boolean.TRUE;
    }
