...
package com.iwindplus.log.application.query.dto;
...
/**
 * 操作日志搜索数据传输对象(search_after深分页).
 *
 * @author zengdegui
 * @since 2024/4/10
 */
@Schema(description = "操作日志搜索数据传输对象(search_after深分页)")
@Data
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public class OperationLogSearchAfterDTO implements Serializable {
    ...
    @Length(max = 100, message = "{operateName.length}")
