...
import com.iwindplus.flow.application.query.instance.FlowHisInstanceQueryService;
...
public class FlowHisInstanceController extends BaseController {
    ...
    private final FlowHisInstanceQueryService flowHisInstanceQueryService;
    ...
    public ResultVO<IPage<FlowHisInstancePageVO>> myInitiated(@Validated FlowHisInstanceSearchDTO entity) {
        ...
        IPage<FlowHisInstancePageVO> data = this.flowHisInstanceQueryService.myInitiatedPage(entity);
    ...
    public ResultVO<IPage<FlowHisInstancePageVO>> myDone(@Validated FlowHisInstanceSearchDTO entity) {
        entity.setUserId(this.getUserInfo().getUserId());
        IPage<FlowHisInstancePageVO> data = this.flowHisInstanceQueryService.myDonePage(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<IPage<FlowHisInstancePageVO>> myCc(@Validated FlowHisInstanceSearchDTO entity) {
        entity.setUserId(this.getUserInfo().getUserId());
        IPage<FlowHisInstancePageVO> data = this.flowHisInstanceQueryService.myCcPage(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<IPage<FlowHisInstancePageVO>> all(@Validated FlowHisInstanceSearchDTO entity) {
        IPage<FlowHisInstancePageVO> data = this.flowHisInstanceQueryService.allPage(entity);
        return ResultVO.success(data);
    }
}