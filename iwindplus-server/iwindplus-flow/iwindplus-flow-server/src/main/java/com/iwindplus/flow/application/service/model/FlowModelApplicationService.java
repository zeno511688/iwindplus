...
import com.iwindplus.flow.application.service.model.dto.FlowModelExtendDTO.FlowModelExtendDTOBuilder;
...
import com.iwindplus.flow.common.enums.FlowFormTypeEnum;
...
public class FlowModelApplicationService {
    ...
    public boolean save(FlowModelSaveDTO entity) {
        ...
        if (CharSequenceUtil.isBlank(entity.getCode())) {
            entity.setCode(this.redissonExecutor.serialNum().getSerialNumDate(FlowCodePrefixEnum.MODEL_PREFIX.code()));
        }
