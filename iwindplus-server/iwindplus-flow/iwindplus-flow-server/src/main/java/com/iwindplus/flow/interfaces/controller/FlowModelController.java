...
import com.iwindplus.flow.application.query.model.FlowModelQueryService;
import com.iwindplus.flow.application.query.model.dto.FlowModelSearchDTO;
import com.iwindplus.flow.application.service.model.FlowModelApplicationService;
import com.iwindplus.flow.application.service.model.dto.FlowModelEditDTO;
import com.iwindplus.flow.application.service.model.dto.FlowModelSaveDTO;
...
public class FlowModelController extends BaseController {
    ...
    private final FlowModelQueryService flowModelQueryService;
    private final FlowModelApplicationService flowModelApplicationService;
    ...
    public ResultVO<Boolean> save(@RequestBody @Validated({SaveGroup.class}) FlowModelSaveDTO entity) {
        boolean data = this.flowModelApplicationService.save(entity);
    ...
    public ResultVO<Boolean> removeByIds(@RequestParam List<Long> ids) {
        boolean data = this.flowModelApplicationService.removeByIds(ids);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> edit(@RequestBody @Validated({EditGroup.class}) FlowModelEditDTO entity) {
        boolean data = this.flowModelApplicationService.edit(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> editStatus(@RequestParam Long id, @RequestParam FlowModelStatusEnum status) {
        boolean data = this.flowModelApplicationService.editStatus(id, status);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> editBuildIn(@RequestParam Long id, @RequestParam Boolean buildInFlag) {
        boolean data = this.flowModelApplicationService.editBuildIn(id, buildInFlag);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<IPage<FlowModelPageVO>> page(@Validated FlowModelSearchDTO entity) {
        IPage<FlowModelPageVO> data = this.flowModelQueryService.page(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<FlowModelExtVO> getDetail(@RequestParam Long id) {
        FlowModelExtVO data = this.flowModelQueryService.getDetail(id);
        return ResultVO.success(data);
    }
}
