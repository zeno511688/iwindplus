...
import com.iwindplus.flow.application.query.base.FlowCategoryQueryService;
import com.iwindplus.flow.application.query.base.dto.FlowCategorySearchDTO;
import com.iwindplus.flow.application.service.base.FlowCategoryApplicationService;
...
public class FlowCategoryController extends BaseController {
    ...
    private final FlowCategoryQueryService flowCategoryQueryService;
    private final FlowCategoryApplicationService flowCategoryApplicationService;
    ...
    public ResultVO<Boolean> save(@RequestBody @Validated({SaveGroup.class}) FlowCategorySaveDTO entity) {
        boolean data = this.flowCategoryApplicationService.save(entity);
    ...
    public ResultVO<Boolean> removeByIds(@RequestParam List<Long> ids) {
        boolean data = this.flowCategoryApplicationService.removeByIds(ids);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> edit(@RequestBody @Validated({EditGroup.class}) FlowCategoryEditDTO entity) {
        boolean data = this.flowCategoryApplicationService.edit(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> editStatus(@RequestParam Long id, @RequestParam EnableStatusEnum status) {
        boolean data = this.flowCategoryApplicationService.editStatus(id, status);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<Boolean> editBuildIn(@RequestParam Long id, @RequestParam Boolean buildInFlag) {
        boolean data = this.flowCategoryApplicationService.editBuildIn(id, buildInFlag);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<IPage<FlowCategoryPageVO>> page(@Validated FlowCategorySearchDTO entity) {
        IPage<FlowCategoryPageVO> data = this.flowCategoryQueryService.page(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<List<FlowCategoryBaseVO>> listEnabled() {
        List<FlowCategoryBaseVO> data = this.flowCategoryQueryService.listEnabled();
        return ResultVO.success(data);
    }
    ...
    public ResultVO<FlowCategoryVO> getDetail(@RequestParam Long id) {
        FlowCategoryVO data = this.flowCategoryQueryService.getDetail(id);
        return ResultVO.success(data);
    }
}
