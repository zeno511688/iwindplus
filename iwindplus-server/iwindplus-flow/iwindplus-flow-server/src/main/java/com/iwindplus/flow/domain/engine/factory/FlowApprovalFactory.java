...
package com.iwindplus.flow.domain.engine.factory;
...
@Slf4j
@Component
public class FlowApprovalFactory implements SmartInitializingSingleton {
     ...
     */
    public FlowApprovalFactory(ObjectProvider<ApprovalHandler> executorProvider) {
