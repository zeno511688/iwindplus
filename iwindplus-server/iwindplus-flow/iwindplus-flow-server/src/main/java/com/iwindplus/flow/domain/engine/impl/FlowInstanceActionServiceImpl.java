...
import com.iwindplus.flow.infrastructure.persistence.model.FlowModelContentDTO;
...
import com.iwindplus.flow.domain.engine.FlowInstanceActionService;
...
public class FlowInstanceActionServiceImpl implements FlowInstanceActionService {
    ...
    public FlowStartInstanceVO startInstance(FlowStartInstanceDTO entity) {
        ...
        String code = redissonExecutor.serialNum().getSerialNumDate("FI");
