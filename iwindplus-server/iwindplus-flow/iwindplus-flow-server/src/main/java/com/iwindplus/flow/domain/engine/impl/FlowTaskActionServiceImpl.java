...
package com.iwindplus.flow.domain.engine.impl;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.text.CharSequenceUtil;
import com.iwindplus.base.domain.exception.BizException;
import com.iwindplus.base.redis.executor.RedissonExecutor;
import com.iwindplus.flow.domain.engine.model.FlowAddTaskPlayerDTO;
import com.iwindplus.flow.domain.engine.model.FlowApproveTaskDTO;
import com.iwindplus.flow.domain.engine.model.FlowConditionNodeDTO;
import com.iwindplus.flow.domain.engine.model.FlowDelegateTaskDTO;
import com.iwindplus.flow.application.service.instance.dto.FlowInstanceEventDTO;
import com.iwindplus.flow.domain.engine.model.FlowJumpTaskDTO;
import com.iwindplus.flow.domain.engine.model.FlowNodeDTO;
import com.iwindplus.flow.domain.engine.model.FlowNodePlayerDTO;
import com.iwindplus.flow.domain.engine.model.FlowRejectTaskDTO;
import com.iwindplus.flow.domain.engine.model.FlowRemoveTaskPlayerDTO;
import com.iwindplus.flow.domain.engine.model.FlowTaskEventDTO;
import com.iwindplus.flow.domain.engine.model.FlowTransferTaskDTO;
import com.iwindplus.flow.common.enums.ApprovalMethodEnum;
import com.iwindplus.flow.common.enums.ApprovalTypeEnum;
import com.iwindplus.flow.common.enums.FlowCodeEnum;
import com.iwindplus.flow.common.enums.FlowInstanceEventTypeEnum;
import com.iwindplus.flow.common.enums.FlowInstanceStatusEnum;
import com.iwindplus.flow.common.enums.FlowNodeTypeEnum;
import com.iwindplus.flow.common.enums.FlowTaskEventTypeEnum;
import com.iwindplus.flow.common.enums.FlowTaskPlayerTypeEnum;
import com.iwindplus.flow.common.enums.FlowTaskStatusEnum;
import com.iwindplus.flow.common.enums.FlowTaskTypeEnum;
import com.iwindplus.flow.domain.engine.model.FlowApprovalResultVO;
import com.iwindplus.flow.domain.engine.FlowEventService;
import com.iwindplus.flow.domain.engine.FlowRuntimeService;
import com.iwindplus.flow.domain.engine.FlowTaskActionService;
import com.iwindplus.flow.domain.engine.FlowVariableService;
import com.iwindplus.flow.domain.engine.factory.FlowApprovalFactory;
import com.iwindplus.flow.domain.engine.support.FlowAssigneeResolver;
import com.iwindplus.flow.domain.engine.support.FlowNodeRouter;
...
public class FlowTaskActionServiceImpl implements FlowTaskActionService {
    ...
    private final FlowApprovalFactory approvalFactory;
    ...
    public boolean approveTask(FlowApproveTaskDTO entity) {
        ...
        // 执行审批策略
        FlowApprovalResultVO result = approvalFactory
    ...
    public void createTaskAndPlayers(
        ...
        String code = redissonExecutor.serialNum().getSerialNumDate("FT");
