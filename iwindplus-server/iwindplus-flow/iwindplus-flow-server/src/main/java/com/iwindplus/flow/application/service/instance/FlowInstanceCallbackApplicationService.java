...
import com.iwindplus.flow.application.service.instance.dto.FlowInstanceCallbackEditDTO;
import com.iwindplus.flow.application.service.instance.dto.FlowInstanceCallbackExtDTO;
...
import com.iwindplus.flow.infrastructure.persistence.instance.FlowHisInstanceDO;
...
public class FlowInstanceCallbackApplicationService {
     ...
     * @return 是否成功
     */
    public boolean executeCallback(FlowInstanceCallbackVO callback) {
        ...
        try {
            ...
            final ResultVO<Boolean> result = httpClientExecuteHandlerFactory
                .getHandler(HttpClientTypeEnum.REST_CLIENT)
                .post(
                    callbackUrl,
                    extDTO,
                    null,
     ...
     */
    private FlowInstanceCallbackExtDTO buildCallbackExtDTO(FlowInstanceCallbackVO callback) {
        // 根据当前状态推断实例状态
    ...
    private void updateCallbackStatus(
        FlowInstanceCallbackVO callback,
     ...
     */
    private void updateCallbackToFailed(FlowInstanceCallbackVO callback, int newRetryCount,
        FlowInstanceCallbackStatusEnum status) {
        FlowInstanceCallbackDO model = FlowInstanceCallbackDO
            .builder()
            .id(callback.getId())
