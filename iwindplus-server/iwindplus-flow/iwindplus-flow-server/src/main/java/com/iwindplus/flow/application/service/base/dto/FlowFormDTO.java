...
package com.iwindplus.flow.application.service.base.dto;
 ...
 * @since 2021/7/8
 */
@Schema(description = "流程表单数据传输对象")
@Data
@EqualsAndHashCode(callSuper = true)
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public class FlowFormDTO extends DbVersionBaseDTO {

    /**
     * 表单状态（DISABLE：禁用，ENABLE：启用，LOCKED：锁定）.
     */
