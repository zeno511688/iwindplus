...
import com.iwindplus.dtx.application.service.TccBranchTxApplicationService;
...
public class TccBranchTxController extends BaseController {
    ...
    private final TccBranchTxQueryService tccBranchTxQueryService;
    private final TccBranchTxApplicationService tccBranchTxApplicationService;
    ...
    public ResultVO<Boolean> removeByIds(@RequestParam List<Long> ids) {
        boolean data = this.tccBranchTxApplicationService.removeByIds(ids);
    ...
    public ResultVO<IPage<TccBranchTxPageVO>> page(@Validated TccBranchTxSearchDTO entity) {
        IPage<TccBranchTxPageVO> data = this.tccBranchTxQueryService.page(entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<TccBranchTxVO> getDetail(@RequestParam Long id) {
        TccBranchTxVO data = this.tccBranchTxQueryService.getDetail(id);
        return ResultVO.success(data);
    }
}
