...
package com.iwindplus.dtx.interfaces.jobhandler;

import cn.hutool.core.date.DatePattern;
import com.iwindplus.base.util.DatesUtil;
import com.iwindplus.dtx.common.enums.DtxTaskJobEnum;
import com.iwindplus.dtx.application.job.DtxTaskJobFactory;
 ...
 */
@Slf4j
@ConditionalOnProperty(prefix = "dtx-task.job", name = "enabled", havingValue = "true", matchIfMissing = true)
@Component
public class DtxTaskJob {

    @Resource
    private DtxTaskJobFactory factory;
    ...
    public void jobExecute() {
        ...
        int failedJobs = 0;
        final DtxTaskJobEnum[] jobEnums = DtxTaskJobEnum.values();
        for (DtxTaskJobEnum entity : jobEnums) {
            try {
