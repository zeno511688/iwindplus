...
package com.iwindplus.dtx.application.job;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.iwindplus.dtx.application.query.TccBranchTxQueryService;
...
import com.iwindplus.dtx.domain.tcc.TccCoordinator;
 ...
 */
@Slf4j
public abstract class AbstractDtxTaskJobHandler implements DtxTaskJobHandler {

    @Resource
    protected DtxTaskProperty property;

    @Resource
    protected TccGlobalTxQueryService tccGlobalTxQueryService;

    @Resource
    protected TccBranchTxQueryService tccBranchTxQueryService;
    ...
    public void execute(Integer shardIndex, Integer shardTotal) {
        ...
        final AbstractDtxTaskJobHandler proxy = SpringUtil.getBean(this.getClass());
        ...
        int loop = 0;
        int total = 0;
        while (loop < property.getJob().getMaxLoopCount()) {
            ...
            final List<TccGlobalTxVO> list = this.tccGlobalTxQueryService.listByShard(param);
