...
package com.iwindplus.gateway.interfaces.listener;
...
import com.iwindplus.gateway.interfaces.filter.ApiWhiteListFilter;
...
public class ApiWhiteListListener {
    ...
    public void listenSingle(Message<String> records, Acknowledgment ack) {
        ...
        try {
            final MessageBaseDTO<ApiWhiteListChangeVO> messageDTO = JacksonUtil.parseObject(records.getPayload(), new TypeReference<>() {
            });
