...
import com.iwindplus.gateway.interfaces.filter.IpBlackListFilter;
...
public class IpBlackListListener {
    ...
    public void listenSingle(Message<String> records, Acknowledgment ack) {
        ...
        try {
            final MessageBaseDTO<IpBlackListChangeVO> messageDTO = JacksonUtil.parseObject(records.getPayload(), new TypeReference<>() {
            });
