...
package com.iwindplus.gateway.infrastructure.support;
...
public class GatewayUtil {
    ...
    public static boolean shouldSkip(ServerWebExchange exchange, Boolean enabled) {
        ...
        Boolean whited = ReactorUtil.<Boolean>getAttribute(
            exchange,
            GatewayWebExchangeConstant.WHITED_FLAG
        );
    ...
    public static void clearRequestParams(ServerWebExchange exchange) {
        ...
        attributes.remove(GatewayWebExchangeConstant.REQUEST_TIME);
        attributes.remove(GatewayWebExchangeConstant.WHITED_FLAG);
        attributes.remove(GatewayWebExchangeConstant.USER_INFO);
    }
    ...
    public static void logTiming(ServerWebExchange exchange, String filterName) {
        final Long start = ReactorUtil.<Long>getAttribute(exchange, GatewayWebExchangeConstant.REQUEST_TIME);
     ...
     */
    public static Mono<GatewayLogDTO> buildGatewayLog(ServerWebExchange exchange, LogProperty cfg) {
        final UserBaseVO user = ReactorUtil.getAttribute(exchange, GatewayWebExchangeConstant.USER_INFO);
        final Long requestTime = ReactorUtil.<Long>getAttribute(exchange, GatewayWebExchangeConstant.REQUEST_TIME);
        final ServerHttpRequest request = exchange.getRequest();
     ...
     * @return Mono<T>
     */
    public static <T> Mono<T> asyncPublishErrorLog(ServerWebExchange exchange, LogProperty cfg, BizException exception) {
    ...
    private static GatewayLogDTO buildRequestData(LogProperty cfg, GatewayLogDTOBuilder<?, ?> builder, ReactorRequestDTO data) {
