...
package com.iwindplus.gateway.infrastructure.gateway.route;
...
import com.iwindplus.gateway.infrastructure.client.vo.ServerRouteParamVO;
import java.net.URI;
...
public class RouteDefinitionConverter {
    ...
    static List<PredicateDefinition> buildPredicateDefinition(List<ServerRouteParamVO> predicateList) {
    ...
    static List<FilterDefinition> buildFilterDefinition(List<ServerRouteParamVO> filterList) {
    ...
    private static boolean isValidSource(ServerRouteDefinitionVO source) {
        ...
        List<ServerRouteParamVO> predicateList = source.getPredicates();
