...
import com.iwindplus.gateway.infrastructure.client.vo.IpBlackListChangeVO;
...
public class IpBlackListFilter extends BaseGatewayFilter {
    ...
    private final IpBlackListProperty property;
    ...
    @Override
    public int getOrder() {
        return GatewayFilterConstant.FILTER_IP_BLACK_LIST_ORDER;
    }
     ...
     * @param message 消息
     */
    public void refreshBlackList(MessageBaseDTO<IpBlackListChangeVO> message) {
        ...
        IpBlackListChangeVO data = message.getData();
