...
package com.iwindplus.im.infrastructure.websocket.handler;
...
public class WsMsgHandler implements IWsMsgHandler {
    ...
    public HttpResponse handshake(HttpRequest httpRequest, HttpResponse httpResponse, ChannelContext channelContext) throws Exception {
        ...
        // 获取用户的群
        final List<Long> groupList = this.chatGroupRepository.getBaseMapper().selectByUserId(userInfo.getUserId(), userInfo.getOrgId());
