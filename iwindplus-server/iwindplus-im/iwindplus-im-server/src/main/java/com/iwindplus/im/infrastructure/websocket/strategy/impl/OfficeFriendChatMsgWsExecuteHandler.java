...
@Slf4j
@Service
public class OfficeFriendChatMsgWsExecuteHandler extends AbstractWsMsgExecuteHandler implements WsMsgExecuteHandler {

    @Resource
    private FriendChatMsgRepository friendChatMsgRepository;
    ...
    public void send(WsSendMsgDTO msg, ChannelContext ctx) {
        ...
        final List<FriendChatMsgVO> list = this.friendChatMsgRepository.listByUnSendSuccess(msg.getSendUserId(), msg.getSendOrgId());
    ...
    private void offlineFriendChatMsg(TioConfig tioConfig, WsSendMsgDTO wsMsg, FriendChatMsgVO entity) {
        ...
        this.friendChatMsgRepository.updateById(param);
    }
}
