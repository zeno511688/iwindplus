...
import com.iwindplus.im.application.query.SysNoticeMsgQueryService;
...
import com.iwindplus.im.application.service.SysNoticeMsgApplicationService;
...
public class SysNoticeMsgController extends BaseController {
    ...
    private final SysNoticeMsgQueryService sysNoticeMsgQueryService;
    private final SysNoticeMsgApplicationService sysNoticeMsgApplicationService;
    ...
    public ResultVO<Boolean> removeByIds(@RequestParam List<String> ids) {
        boolean data = this.sysNoticeMsgApplicationService.removeByIds(ids);
    ...
    public ResultVO<IPage<SysNoticeMsgPageVO>> page(PageDTO<SysNoticeMsgDO> page, @Validated SysNoticeMsgSearchDTO entity) {
        ...
        IPage<SysNoticeMsgPageVO> data = this.sysNoticeMsgQueryService.page(page, entity);
        return ResultVO.success(data);
    }
    ...
    public ResultVO<SysNoticeMsgVO> getDetail(@RequestParam String id) {
        SysNoticeMsgVO data = this.sysNoticeMsgQueryService.getDetail(id);
        return ResultVO.success(data);
    }
}
